//! TotalVolatileOrganicCompoundsConcentrationMeasurement cluster (0x042E).
...
/// Cluster ID.
pub const CLUSTER_ID: u32 = 0x042E;
/// Cluster revision.
...
bitflags::bitflags! {
    /// `TotalVolatileOrganicCompoundsConcentrationMeasurement` feature bits (FeatureMap).
